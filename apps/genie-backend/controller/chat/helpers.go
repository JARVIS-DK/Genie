...
import (
	...
	"apps/genie-backend/controller/chat/agents"
	"apps/genie-backend/controller/chat/agents/audio_generation"
	"apps/genie-backend/controller/chat/agents/deep_research"
	image_generation "apps/genie-backend/controller/chat/agents/image_generation"
	prompt_generator "apps/genie-backend/controller/chat/agents/prompt_generator"
	"apps/genie-backend/controller/chat/agents/video_generation"
	"encoding/json"
	"errors"
	"fmt"
	"libs/shared"
