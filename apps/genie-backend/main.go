...
import (
	...
	"apps/opsMatrix-backend/config"
	backend "apps/opsMatrix-backend/controller"
	shared "libs/shared"
...
func main() {
	...
	e.Use(
		...
		middleware.LoggerWithConfig(middleware.LoggerConfig{
			Format:           fmt.Sprintf("opsMatrix : | ${host} | ${time_custom} | ${status} | ${latency_human} | ${remote_ip} | ${method} | ${uri} "),
