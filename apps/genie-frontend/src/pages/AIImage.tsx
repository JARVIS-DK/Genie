...
export default function AIImagePage({ isSidebarOpen, onToggleSidebar }: PageProps) {
  return (
        ...
        <div className="h-full overflow-y-auto px-6 py-6">
          <div className="max-w-3xl mx-auto">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h2 className="text-2xl font-semibold">AI Image</h2>
            </div>
            <p className="text-muted-foreground text-sm mb-6">Demo page. Plug your image generator here.</p>
            <div className="rounded-xl border border-border bg-card/60 p-6">
              <p className="text-sm text-foreground/90">This is a demo placeholder for AI Image.</p>
            </div>
          </div>
        </div>
      </div>
