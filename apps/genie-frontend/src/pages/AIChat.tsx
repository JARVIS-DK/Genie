...
import { Bot, PanelLeft, MessageSquare } from "lucide-react";
      ...
      <div className="flex-1 relative overflow-hidden">
        ...
        <div className="h-full overflow-y-auto px-6 py-6" style={{ scrollbarWidth: 'thin', scrollbarColor: 'hsl(var(--border)) transparent' }}>
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground text-sm mb-6">Demo page. A placeholder chat experience.</p>
            <div className="rounded-xl border border-border bg-card/60 p-6">
              <p className="text-sm text-foreground/90">This is a demo placeholder for AI Chat.</p>
            </div>
          </div>
        </div>
      </div>
