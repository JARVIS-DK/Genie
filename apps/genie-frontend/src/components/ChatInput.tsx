            ...
            <PromptInputActions className="flex items-center justify-between gap-2 p-0 pt-2">
              <div
                className={cn(
                  ...
                  isRecording ? "opacity-100" : "opacity-100"
                )}
              >
              ...
              <div className="flex items-center gap-2">
                ...
                <PromptInputAction tooltip={hasContent ? "Send message" : "Type a message"}>
                  <Button
                    variant="default"
                    size="icon"
                    className={cn(
...
export const ChatInput = PromptInputBox;
