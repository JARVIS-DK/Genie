    ...
    <div className="flex items-center w-full justify-between gap-2">
      ...
      {slide.processed && (
        <div className="flex gap-6">
          {/* Edit Slide */}
          {slide.html && !isEditMode && !isHtmlEditMode && (
            <>
              <ToolTip content="Edit slide with AI">
                <button
                  onClick={onEditClick}
                  disabled={isProcessing || !slide.processed}
                  className={`px-6 py-2 flex gap-2 text-sm items-center rounded-lg bg-[#5141e5] hover:shadow-md transition-all duration-300 shadow-md ${
              ...
              <ToolTip content="Edit HTML directly">
                <button
                  ...
                  disabled={isProcessing || !slide.processed}
                  className={`px-6 py-2 flex gap-2 text-sm items-center rounded-lg bg-purple-600 hover:bg-purple-700 hover:shadow-md transition-all duration-300 shadow-md ${
                    isProcessing || !slide.processed
                      ? "opacity-50 cursor-not-allowed"
                      : ""
                  }`}
          ...
          <ToolTip content="Delete Slide">
            <button
              ...
              onClick={onDelete}
              className={`px-4 py-2 flex gap-2 text-sm items-center rounded-lg hover:shadow-md transition-all duration-300 shadow-md ${
