...
export function OutlineItem({
  ...
  /** Throttled markdown rendering for the streaming item */
  ...
  /** Memoized HTML for completed streamed items */
  ...
  return (
    <div className="mb-2">
      <div
        ref={setNodeRef}
        style={style}
        className={`flex items-start gap-2 md:gap-4 p-2 sm:pr-4 border border-black/10 bg-purple-100/10 rounded-[8px] ${
